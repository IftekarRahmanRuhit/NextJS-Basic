      ...
      <div className="">
        <nav className="bg-gradient-to-r from-amber-50 via-amber-100 to-amber-50 text-gray-800 shadow-lg  border border-amber-200/50 backdrop-blur-sm ">
          ...
          <ul className="hidden md:flex justify-center items-center text-center gap-8 py-4">
            <Link href="/">
              <li
                className={`px-6 py-2 rounded-lg font-medium transition-all duration-300 hover:bg-amber-200/70 hover:text-amber-900 hover:scale-105 hover:shadow-md cursor-pointer active:scale-95 ${
                  pathName === "/"
          ...
          <div className="md:hidden">
            ...
            >
              <div className="px-4 pb-3 space-y-2">
                <Link href="/">
                  <li
                    className={`block px-4 py-3 rounded-lg font-medium transition-all duration-200 hover:bg-amber-200/70 hover:text-amber-900 cursor-pointer active:bg-amber-300/50 ${
